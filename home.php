                          ...
                          WHERE enrolledcourse.EmpID =$id");
                                    ...
                                    if ($sql->num_rows > 0){
                                              while($row = mysqli_fetch_array($sql))
                                                ...
                                                echo "<td><a href='http://localhost/et3/stream_lesson.php?url=$row[COURSE_URL]&title=$row[COURSE_NAME]' target=\'_blank'\>". "Take Course" . "</a></td>";
                                                echo "<td>".$row['TRAINER_FIRSTNAME']." ".$row['TRAINER_LASTNAME']."</td>";
                                                 echo "<td><a href='http://localhost/et3/show_quiz.php?url=$row[QUIZ_URL]&title=$row[COURSE_NAME]' target=\'_blank'\>"."Take Quiz"."</a></td>";
